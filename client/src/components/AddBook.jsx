            ...
            {!msg ? (
                <div className="bg-amber-300">
                    ...
                    <form className="max-w-md mx-auto">
                        ...
                        <p className="text-xl justify-center mb-5">Add a Book</p>
                        ...
                        <button type="submit" className="mb-5 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" onClick={addABook}>Submit</button>
                    </form>
